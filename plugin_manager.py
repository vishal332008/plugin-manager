...
class PluginManagerWindow(bui.Window):
    ...
    def draw_category_selection_button(self, post_label):
        ...
        if self.category_selection_button is None:
            self.alphabet_order_selection_button = bui.buttonwidget(parent=self._root_widget,
                                                                    ...
                                                                    on_activate_call=(
                                                                        lambda: loop.create_task(self._on_order_button_presse())),
                                                                    button_type="square",
                                                                    textcolor=b_textcolor,
                                                                    text_scale=0.6)
        else:
    ...
    async def _on_order_button_presse(self) -> None:
    ...
    async def draw_plugin_names(self, category, search_term="", refresh=False, order=None):
